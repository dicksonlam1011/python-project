...
ppm_summary = pd.ExcelFile('/Users/lamlapman/Desktop/Python-Development/python-project/PPM-Statistics/python-project-source/promotion_summary_{}_Backup.xls'.format(summary_year))
relese_schedule = pd.ExcelFile("//Users/lamlapman/Desktop/Python-Development/python-project/PPM-Statistics/python-project-source/Deployment_release_schedule_Backup.xlsx")
